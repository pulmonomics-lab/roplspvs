...
```{r, echo=FALSE}
  ...
  summary_Model_tablesignificant <- subset(summary_Model_table,summary_Model_table$`pQ2 perm. over v.s.`<=0.05 & summary_Model_table$`R2Y(cum) post v.s.`>=0.5 & summary_Model_table$`Q2(cum) post v.s.`>=0.4 & as.numeric(summary_Model_table$`Corr perm. coeff Q2`)>=0.1&as.numeric(summary_Model_table$`Corr perm. p value Q2`)<=0.05)
summary_Model_tablesignificanttokable <- summary_Model_tablesignificant
summary_Model_tablesignificanttokable[,c(9,10,11,12,24,25,26)] <- format(round(summary_Model_tablesignificanttokable[,c(9,10,11,12,24,25,26)],3),nsmall=3)
