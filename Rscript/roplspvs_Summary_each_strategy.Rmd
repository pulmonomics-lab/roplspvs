...
summary_Model_tabletokable[,c(9,10,11,12)] <- 
  format(round(summary_Model_tabletokable[,c(9,10,11,12)], digits=3))
summary_Model_tabletokable[,c(19,20,21)] <- 
  format(round(summary_Model_tabletokable[,c(19,20,21)], digits=2))
...
summary_Model_tablesignificanttokable[,c(9,10,11,12)] <- format(round(summary_Model_tablesignificanttokable[,c(9,10,11,12)],3))
