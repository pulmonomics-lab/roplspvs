...
if (1 %in% model_strategies_to_run) {
  ...
  description_Model1 <-
    "Models with userset p(corr) cutoff during variable selection and userset number of orthogonal variables pre and post variable selection"
...
if (2 %in% model_strategies_to_run) {
  ...
  description_Model2 <-
    "Model with p(corr) cutoff corresponding to userset pvalue cutoff for correlation"
...
if (3 %in% model_strategies_to_run) {
  ...
  description_Model3 <-
    "Model with variable using p(corr) cutoff resulting in best performing model post variable selection"
...
if (4 %in% model_strategies_to_run) {
  ...
  description_Model4 <-
    "Model with variable using p(corr) cutoff resulting in best performing model with userset max p(pearson)  and using minimal amount of variables"
...
if (5 %in% model_strategies_to_run) {
  ...
  description_Model5 <-
    "Iteration models removing variables with lowest p(corr) iteratively"
