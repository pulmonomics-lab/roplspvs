...
description_Model0 <- "Models pre variable selection and number of orthogonal variables using default ropls"
model_description <- description_Model0
model_strategy<-0}
  
```

```{r, child=if (0 %in% model_strategies_to_run) paste(directory_Rmarkdownfiles,'/roplspvs_Summary_of_models_pre_vs.Rmd',sep="")}
