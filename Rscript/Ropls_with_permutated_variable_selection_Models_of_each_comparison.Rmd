...
max number of orthogonal variables in model pre variable selection in Model strategy 2: `r max_no_of_ortho_pre_vs_in_Model2`

max number of orthogonal variables in model pre variable selection in Model strategy 3 and 4: `r max_no_of_ortho_pre_vs_in_Model3_and_Model4`

max number of orthogonal variables in model post variable selection in Model strategy 2: `r max_no_of_ortho_post_vs_in_Model2`

max number of orthogonal variables in model post variable selection in Model strategy 3 and 4: `r max_no_of_ortho_post_vs_in_Model3_and_Model4`
