...
directory_Rmarkdownfiles <- paste(directory_of_Ropls_with_permutated_variable_selection,"/",foldername_Rmarkdownfiles,"/",sep="")
...
```{r, child=if (1 %in% model_strategies_to_run) paste(directory_Rmarkdownfiles,'/Ropls_with_permutated_variable_selection_Summary_each_strategy.Rmd',sep="")}
...
```{r, child=if (2 %in% model_strategies_to_run) paste(directory_Rmarkdownfiles,'/Ropls_with_permutated_variable_selection_Summary_each_strategy.Rmd',sep="")}
...
```{r, child=if (3 %in% model_strategies_to_run) paste(directory_Rmarkdownfiles,'/Ropls_with_permutated_variable_selection_Summary_each_strategy.Rmd',sep="")}
...
```{r, child=if (4 %in% model_strategies_to_run) paste(directory_Rmarkdownfiles,'/Ropls_with_permutated_variable_selection_Summary_each_strategy.Rmd',sep="")}
...
```{r, child=if (5 %in% model_strategies_to_run) paste(directory_Rmarkdownfiles,'/Ropls_with_permutated_variable_selection_Summary_iteration_model.Rmd',sep="")}
...
```{r, child=if (2 %in% model_strategies_to_run) paste(directory_Rmarkdownfiles,'/Ropls_with_permutated_variable_selection_Summary_pcorr_selected_variables.Rmd',sep="")}
...
```{r, child=if (3 %in% model_strategies_to_run) paste(directory_Rmarkdownfiles,'/Ropls_with_permutated_variable_selection_Summary_pcorr_selected_variables.Rmd',sep="")}
...
```{r, child=if (4 %in% model_strategies_to_run) paste(directory_Rmarkdownfiles,'/Ropls_with_permutated_variable_selection_Summary_pcorr_selected_variables.Rmd',sep="")}
...
```{r, child=if (5 %in% model_strategies_to_run) paste(directory_Rmarkdownfiles,'/Ropls_with_permutated_variable_selection_Summary_pcorr_selected_variables.Rmd',sep="")}
